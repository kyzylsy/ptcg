...
+ Pokémon Card Game XY: 
   + [ ] CP1: マグマ団VSアクア団ダブルクライシス (Magma Gang VS Aqua Gang: Double Crisis)
   + [ ] CP2: 伝説キラコレクション (Legendary Shine Collection)
+ Pokémon Card Game XY BREAK:
   + [ ] CP3: ポケキュンコレクション (Pokékyun Collection)
   + [ ] CP4: プレミアムチャンピオンパック「EX×M×BREAK」(Premium Champion Pack: EX×M×BREAK)
   + [ ] CP5: 幻・伝説ドリームキラコレクション (Mythical & Legendary Dream Shine Collection)
+ Pokémon Card Game Sun & Moon:
...
+ Pokémon Card Game:
   ...
   + [ ] クイック・コンストラクション・パック「タイプユニット:草」(Quick Construction Pack Type Unit: Grass Deck)
   + [ ] クイック・コンストラクション・パック「タイプユニット:炎」(Quick Construction Pack Type Unit: Fire Deck)
   + [ ] クイック・コンストラクション・パック「タイプユニット:水」(Quick Construction Pack Type Unit: Water Deck)
   + [ ] クイック・コンストラクション・パック「タイプユニット:雷」(Quick Construction Pack Type Unit: Thunder Deck)
   + [ ] クイック・コンストラクション・パック「タイプユニット:超」(Quick Construction Pack Type Unit: Psychic Deck)
   + [ ] クイック・コンストラクション・パック「タイプユニット:闘」(Quick Construction Pack Type Unit: Fighting Deck)
...
+ Pokémon Card Game DP:
   ...
   + [ ] 構築スタンダードデッキ「ディアルガLV.X」(Constructed Standard Deck Dialga LV.X)
   + [ ] 構築スタンダードデッキ「パルキアLV.X」(Constructed Standard Deck Palkia LV.X)
...
+ Pokémon Card Game DPt:
   + [x] エントリーパック (Entry Pack)
   + [x] ギフトボックス (Gift Box)
   + [ ] 対戦スターターパックSP「ゴウカザルVSエルレイド」(Competition Starter Pack SP Goukazaru VS Erureido)
   + [ ] 対戦スターターパックSP「ガブリアスVSリザードン」(Competition Starter Pack SP Gaburias VS Lizardon)
...
+ Pokémon Card Game XY:
   + [ ] X30: ゼルネアスデッキ30 (Xerneas Half Deck)
   + [ ] Y30: イベルタルデッキ30 (Yveltal Half Deck)
   + [ ] XYA: メガバトルデッキ60「MリザードンEX」(Mega Battle Deck 60 MLizardonEX)
   + [ ] XYB: ハイパーメタルチェーンデッキ60「ディアルガEX +ギルガルドEX」(Hyper Metal Chain Deck DialgaEX+GillgardEX)
   + [ ] XYC: スーパーレジェンドセット60「ゼルネアスEX・イベルタルEX」(Super Legend Set Xerneas-EX & Yveltal-EX)
   + [ ] XYD: メガバトルデッキ60「MレックウザEX」(Mega Battle Deck 60 MRayquazaEX)
   + [ ] XYE: 対戦スタートセット30「エンブオーEX VS トゲキッスEX」(Competition Start Set 30 Enbuoh-EX VS Togekiss-EX)
   + [ ] MMB: MマスターデッキビルドBOX「パワースタイル」(M Master Deck Build Box Power Style)
   + [ ] MMB: MマスターデッキビルドBOX「スピードスタイル」(M Master Deck Build Box Speed Style)
+ Pokémon Card Game XY BREAK:
   + [ ] SNP: BREAK進化パック「ライチュウBREAK」(BREAK Evolution Pack RaichuBREAK)
   + [ ] SNP: BREAK進化パック「オンバーンBREAK」(BREAK Evolution Pack OnvernBREAK)
   + [ ] XYF: BREAKコンボデッキ60「ゴルダックBREAK+パルキアEX」(BREAK Combo Deck 60 GolduckBREAK+PalkiaEX)
   + [ ] XYG: パーフェクトバトルデッキ60「ジガルデEX」(Perfect Battle Deck 60 ZygardeEX)
   + [ ] XYH: メガバトルデッキ60「MメガタブンネEX」(Mega Battle Deck 60 MTabunneEX)
+ Pokémon Card Game Sun & Moon:
   + [ ] SM0: ピカチュウと新しい仲間たち (Pikachu's New Friends Collection)
   ...
   + [ ] SMH: GXスタートデッキ「草ラランテス」(Grass Lurantis-GX Deck)
   + [ ] SMH: GXスタートデッキ「炎リザードン」(Fire Charizard-GX Deck)
   + [ ] SMH: GXスタートデッキ「水ラプラス」(Water Lapras-GX Deck)
   + [ ] SMH: GXスタートデッキ「雷ライチュウ」(Lightning Raichu-GX Deck)
   + [ ] SMH: GXスタートデッキ「超ミュウツー」(Psychic Mewtwo-GX Deck)
   + [ ] SMH: GXスタートデッキ「闘ルガルガン」(Fighting Lycanroc-GX Deck)
   + [ ] SMH: GXスタートデッキ「悪イベルタル」(Darkness Yveltal-GX Deck)
   + [ ] SMH: GXスタートデッキ「鋼メタグロス」(Metal Metagross-GX Deck)
   + [ ] SMH: GXスタートデッキ「フェアリーゼルネアス」(Fairy Xerneas-GX Deck)
