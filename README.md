...
+ Pokémon Card Game BW:
   ...
   + [x] BKR: バトル強化デッキ60「レシラムＥＸ」(Battle Strength Deck ReshiramEX)
   + [x] BKZ: バトル強化デッキ60「ゼクロムＥＸ」(Battle Strength Deck ZekromEX)
   + [x] BGS: バトルギフトセット「ボルトロスＶＳトルネロス」(Battle Gift Set Thundurus vs Tornadus)
