...
+ Pokémon Card Game e-Series: ✔ Era Complete
...
+ Pokémon Card Game Sun & Moon: ✔ Era Complete
   ...
   + [x] SM4S: 拡張パック「覚醒の勇者」(Awakened Heroes)
   + [x] SM4A: 拡張パック「超次元の暴獣」(Ultradimensional Beasts)
   + [x] SM5S: 拡張パック「ウルトラサン」(Ultra Sun)
   + [x] SM5M: 拡張パック「ウルトラムーン」(Ultra Moon)
   + [x] SM6:  拡張パック「禁断の光」(Forbidden Light)
...
+ Pokémon Card Game:
   ...
   + [x] 映画公開記念VSパック「裂空のデオキシス」(Movie Commemoration VS Pack: Sky-Splitting Deoxys)
   ...
   + [x] 構築済みスターター「メガニウムex★草」(Pre-built Starter Meganium ex ★Grass)
   + [x] 構築済みスターター「バクフーンex★炎」(Pre-built Starter Bakphoon ex ★Fire)
   + [x] 構築済みスターター「オーダイルex★水」(Pre-built Starter Ordile ex ★Water)
   + [x] 構築済みスターター「まぼろしのミュウ」(Pre-built Starter Mirage's Mew)
   + [x] マスターキット (Master Kit)
   + [x] 映画公開記念VSパック「波導のルカリオ」(Movie Commemoration VS Pack: Wave's Lucario)
   + [x] ホロンの研究塔ハーフデッキ1/2炎EX (Holon Research Tower Half Deck 1/2 Fire EX)
   + [x] ホロンの研究塔ハーフデッキ1/2水EX (Holon Research Tower Half Deck 1/2 Water EX)
   + [x] ホロンの研究塔ハーフデッキ1/2雷EX (Holon Research Tower Half Deck 1/2 Lightning EX)
...
+ Pokémon Card Game BW:
   ...
   + [x] BK: バトル強化デッキ「コバルオン」(Battle Strength Deck Cobalion)
   + [x] BTV: バトルテーマデッキ「ビクティニ」(Battle Theme Deck Victini)
   + [x] BKR: バトル強化デッキ60「レシラムEX」(Battle Strength Deck ReshiramEX)
   + [x] BKZ: バトル強化デッキ60「ゼクロムEX」(Battle Strength Deck ZekromEX)
   + [x] BGS: バトルギフトセット「ボルトロスVSトルネロス」(Battle Gift Set Thundurus vs Tornadus)
   + [x] SZD: サザンドラデッキ30 (Sazandora Half Deck)
   + [x] GBR: ガブリアスデッキ30 (Gaburias Half Deck)
   + [x] KLD: バトル強化デッキ30「ケルディオ」(Battle Strength Deck Keldeo)
...
+ Pokémon Card Game Sword & Shield:
   ...
   + [x] sD: Vスタートデッキ水「ホエルオー」(Water Wailord V Deck)
   + [x] sD: Vスタートデッキ雷「ピカチュウ」(Lightning Pikachu V Deck)
   + [x] sD: Vスタートデッキ超「ミュウ」(Psychic Mew V Deck)
   + [x] sD: Vスタートデッキ闘「ルカリオ」(Fighting Lucario V Deck)
   + [x] sD: Vスタートデッキ悪「ガラルヤドラン」(Darkness Galarian Slowbro V Deck)
   + [x] sD: Vスタートデッキ鋼「ジュラルドン」(Metal Duraludon V Deck)
   + [x] sD: Vスタートデッキ無色「イーブイ」(Colorless Eevee V Deck)
...
+ Pokémon Card Game Scarlet & Violet
   ...
   + [x] SVJL: バトルマスターデッキ テラスタル リザードンex(Battle Master Deck Terastal Charizard ex)
   + [x] SVJP: バトルマスターデッキ パオジアンex(Battle Master Deck Chien-Pao ex)
   + [x] SVK: デッキビルドBOX ステラミラクル(Stellar Miracle Deck Build Box)
   + [x] SVLN: スターターセット テラスタイプ:ステラ ニンフィアex(Stellar Tera Type Starter Set Sylveon ex)
...
+ Pokémon Card Game MEGA
   ...
   + [x] MP1: スタートデッキ100 バトルコレクション コロちゃおVer.(Start Deck 100 Battle Collection CoroCiao Version)
   + [x] ME: [スターターセットex](https://www.pokemon-card.com/ex/me/)(2026 ex Starter Sets)
