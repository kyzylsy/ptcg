...
CREATE TABLE `release` (
	`id`           INT NSIGNED      NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT '商品id',
	...
	`icon`         VARCHAR(256)              DEFAULT NULL COMMENT 'oss存储路径',
...
CREATE TABLE `card` (
	`id`           INT NSIGNED      NOT NULL PRIMARY KEY AUTO_INCREMENT COMMENT '卡牌id',
	`release`      INT UNSIGNED     NOT NULL DEFAULT 0    COMMENT '所属商品',
